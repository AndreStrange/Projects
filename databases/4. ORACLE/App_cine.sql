...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-02-2021 a las 02:17:29
...
(1, 'Everything Must Go', 'Camila', 'Comedy|Drama', 'Oriya', 'YES', 'Indonesia', 2002, 'https://intel.com', '03:01:19', '16', '2010-09-19', 'arcu adipiscing molestie hendrerit at vulputate vitae nisl aenean lectus pellentesque eget nunc donec quis orci eget orci vehicula'),
...
--
ALTER TABLE `funciones`
  MODIFY `id_funcion` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `peliculas`
  MODIFY `id_pelicula` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `peliculas_fuera_de_cartelera`
--
ALTER TABLE `peliculas_fuera_de_cartelera`
  MODIFY `pk_fuera_de_cartelera` bigint(20) NOT NULL AUTO_INCREMENT;
